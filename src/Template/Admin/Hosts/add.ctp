<div class="row">
    <div class="col-md-5 mx-auto">
        ...
        <h3 class="page-subtitle">Einen neuen Veranstalter hinzufügen</h3>
        <div class="wrapper">
            <div class="d-flex flex-column justify-content-end" id="host-image">
                <p id="helptext">Bitte ein Bild auswählen...</p>
                ...
                <input id="hostImageId" type="hidden" name="logo_id" value="">
            </div>
            <p class="h5 form-label">Name</p>
<!--            <input name="name" type="text" class="form-control mb-2" autocomplete="off" required>-->
...
<!--            <input name="website_url" type="text" class="form-control mb-2" autocomplete="off" placeholder="beginnend mit http:// bzw. https://" required>-->
