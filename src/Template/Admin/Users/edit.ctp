...
<?php //TODO: Formular zum bearbeiten ?>
...
<nav class="large-2 medium-3 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                ...
                ['confirm' => __('Bist du dir sicher, dass du diesen Benutzer entgültig löschen möchtest? # {0}', $user->id)]
            )
        ?></li>
    </ul>
</nav>
        ...
        <div class="row">
            <div class="form-group w-100">
                <div class="input-group">
                    ...
                    <input type="text" name="username" value="<?= $user->username ?>" class="form-control" id="users-username-input" aria-label="Users's username" aria-describedby="users-username-input-addon">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group w-100">
                <div class="input-group">
                    ...
                    <input type="text" name="name" value="<?= $user->name ?>" class="form-control" id="users-name-input" aria-label="User's name" aria-describedby="users-name-input-addon">
                </div>
            </div>
        </div>
        <div class="row">
